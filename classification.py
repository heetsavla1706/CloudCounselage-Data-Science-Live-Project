...
s = SGDClassifier(loss="hinge", penalty="l2", max_iter=100)
s.fit(X, y)
yhat2 = s.predict(X_test)
print('F1 Score For Linear Regression : ',f1_score(y_test,yhat2))
...
yhat3 = g.predict(X_test)
print('F1 Score For Gaussian Naive Bayes : ',f1_score(y_test,yhat3))
